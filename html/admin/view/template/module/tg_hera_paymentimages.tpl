...
<div class="box">
  ...
  <div class="content">
   <div id="tabs" class="htabs"><a href="#tab_general"><?php echo $tab_gen; ?></a><a href="#tab_image"><?php echo $tab_sliderimage; ?></a><a href="#tab_socialnetwork"><?php echo $tab_socialnetwork; ?></a></div>
    ...
    <table class="form">
		...
		<tr>
          ...
          <td colspan="3"><select name="tg_hera_paymentimages_totop">
              <?php if ($tg_hera_paymentimages_totop) { ?>
	  ...
	  <div id="tab_socialnetwork">
				<table class="form">
					<tr>
						<td>Status</td>
						<td><select name="tg_hera_footer_social_icon_show">
						<?php if ($tg_hera_footer_social_icon_show) { ?>
